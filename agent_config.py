...
# P-DQN  
P_DQN_Vanilla_agent_config = {'agent_name': 'P-DQN', 'gamma' : 0.99, 'discrete_tau': 0.01, 'continuous_tau': 0.001, 'update_freq': 1, 'target_update_freq': 2,
                        'batch_size': 128, 'warm_up': 512, 'lr_disc_actor': 0.0002, 'lr_cont_actor': 0.00002, 'buffer_size': 1000000,
                        'use_PER': False, 'use_ERE': False, 'reward_normalize' : False}
P_DQN_Vanilla_agent_config['extension'] = {'name': 'Vanilla', 'gaussian_std': 0.5, 'min_std': 0.01, 'noise_clip': 0.5, 'noise_reduction_rate': 0.99999, 'use_Twin_Delay': False,
                                           'epsilon': 0.99, 'epsilon_decaying_rate': 0.99999, 'min_epsilon': 0.1, 'use_DDQN': True}
